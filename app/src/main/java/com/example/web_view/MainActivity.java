...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vig.getSettings().setPluginState(WebSettings.PluginState.OFF);
        vig.getSettings().setLoadWithOverviewMode(true);
        vig.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);
        vig.getSettings().setUseWideViewPort(true);
        vig.getSettings().setUserAgentString("Android Mozilla/5.0 AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30");
        vig.getSettings().setAllowFileAccess(true);
        vig.getSettings().setAllowFileAccess(true);
    ...
    public class ChromeClient extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView view, ValueCallback<Uri[]> filePath, WebChromeClient.FileChooserParams fileChooserParams) {
            ...
            contentSelectionIntent.setType("camera");
